...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: _objectSpread(_objectSpread({}, (0,vuex__WEBPACK_IMPORTED_MODULE_0__.mapActions)(['fetchTasks', 'deleteTask'])), {}, {
    addTask: function addTask() {
      var _this = this;
      var form = this.$refs.formTask;
...
var render = function render() {
  ...
  return _c("div", {
    ...
    }, [_vm._v("Assigned to: " + _vm._s(task.user.name))])]), _vm._v(" "), task.completed ? _c("div", [_c("span", [_vm._v("Completed ✅")])]) : _c("div", [_c("button", {
    ...
    attrs: {
      id: "taskTitle",
      type: "text",
      placeholder: "Read book design patterns",
      required: ""
    },
    domProps: {
      value: _vm.newTask.title
  ...
  }, [_vm._v("Task description")]), _vm._v(" "), _c("input", {
    directives: [{
      name: "model",
      rawName: "v-model",
    ...
    attrs: {
      id: "description",
      type: "text",
      placeholder: "Read book every day",
      required: ""
    },
    domProps: {
      value: _vm.newTask.description
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (new vuex__WEBPACK_IMPORTED_MODULE_2__["default"].Store({
  ...
  actions: {
    addTask: function addTask(_ref, task) {
      ...
      return axios__WEBPACK_IMPORTED_MODULE_0___default().post('/tasks', task).then(function (response) {
        var newTask = response.data.data;
    ...
    updateTask: function updateTask(_ref2, task) {
      ...
      axios__WEBPACK_IMPORTED_MODULE_0___default().put("/tasks/".concat(task.id), task).then(function (response) {
        var updatedTask = response.data.data;
    ...
    fetchTasks: function fetchTasks(_ref4) {
      ...
      axios__WEBPACK_IMPORTED_MODULE_0___default().get('/tasks') // Hacemos la petición GET a la ruta
      .then(function (response) {
